        ...
        $.ajax({
            ...
            success: function(datos){
                    ...
                    var stringDatos =  "<ul><li>Número de elementos del XML: " + totalNodos + "</li>";
                        ...
                        stringDatos += '<img src="https://openweathermap.org/img/w/' + icono +'.png"></img>';
...
class Executor {
    ...
    run() {
        new Meteo("Navia").cargarDatos();
        new Meteo("Oviedo").cargarDatos();
        new Meteo("Aviles").cargarDatos();
        new Meteo("Taramundi").cargarDatos();
        new Meteo("Lugo").cargarDatos();
    }
}
